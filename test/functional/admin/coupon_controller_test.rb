...
require 'admin/coupon_controller'

# Re-raise errors caught by the controller.
class Admin::CouponController; def rescue_action(e) raise e end; end

class Admin::CouponControllerTest < Test::Unit::TestCase
  fixtures :coupons

  def setup
    @controller = Admin::CouponController.new
