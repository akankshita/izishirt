...
#  map.connect 'contest/:controller/:action/:id', :controller=>"contest/:controller"
  ...
  map.connect 'local/custom-t-shirt-printing', :controller => 'local', :action => 'custom_t_shirt_printing'
  ...
  map.connect 'frch/:controller/:action/:id/:order/:way'
  map.connect 'frch/:controller/:action/:id/:order'
  map.connect 'frch/:controller/:action/:id.:format'
  map.connect 'frch/:controller/:action/:id'
  map.connect 'frch/:controller/:action.:format'
